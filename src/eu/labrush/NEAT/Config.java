...
public class Config {
    ...
    static double P_NODE_BIAS_MUTATION      = 0.2 ;


    static double SAME_SPECIES_THRESHOLD     = 3.9 ;
    static double SURVIVAL_SPECIES_THRESHOLD = 0.2 ;

    static double MAX_CONNECTION_WEIGHT = 30.0 ;
    static double MIN_CONNECTION_WEIGHT = -MAX_CONNECTION_WEIGHT;
    static double STDEV_CONNECTION_WEIGHT = 1.0 ;

    static double MAX_NODE_BIAS = 30.0 ;
    static double MIN_NODE_BIAS = - MAX_NODE_BIAS ;
    static double STDEV_NODE_BIAS = 1.0 ;
